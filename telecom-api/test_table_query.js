...
async function testTableQuery() {
    ...
    "dataRequest": [
      {
        ...
        "retryHints": {
          ...
          "isLastRetry": false,
          "retryCount": 0,
          "originalRequestId": "cd-jfut5i1r5d_0_0"
        }
      }
    ]
  };
  ...
  try {
    ...
    fs.writeFileSync('d:/proyecrh/telecom-api/table_data_result.json', text);
    const parsed = JSON.parse(text);
    console.log('Result:', JSON.stringify(parsed, null, 2).substring(0, 1500));
  } catch (err) {
