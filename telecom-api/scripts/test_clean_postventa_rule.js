...
async function testCleanPostventaRule() {
  try {
    console.log("=== PROBANDO REGLA PURA DE POSTVENTA EN CADA MES DE 2026 ===\n");
    ...
    for (let m = 1; m <= 8; m++) {
      ...
      const [rows] = await pool.query(`
        SELECT 
          -- Postventa pura por Tipo de Trabajo y Producto
          COUNT(CASE WHEN (
      ...
      console.log(`   POSTVENTA: WIN [${of.pv_asig} Asig, ${of.pv_fin} Fin, ${of.pv_ef}%] | BD [${r.pv_asig} Asig, ${r.pv_fin} Fin, ${efPv}%] (Dif Asig: ${r.pv_asig - of.pv_asig}, Dif Fin: ${r.pv_fin - of.pv_fin})`);
