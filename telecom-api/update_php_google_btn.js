                ...
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-<?= $meta['color'] ?> text-white py-2 d-flex align-items-center justify-content-between">
                        ...
                        <?php if ($grupo === 'tiempo_real'): ?>
                            <button type="button" id="btn_conectar_google" class="btn btn-light btn-sm fw-bold text-danger d-inline-flex align-items-center gap-1 shadow-sm">
...
console.log('✅ index.php actualizado con el botón de Google!');
