...
<div class="react-app-wrapper">
    <iframe 
        src="<?= base_url() ?>public/dist_react/index.html?v=<?= $v ?>&userId=<?= urlencode($userId) ?>&userName=<?= urlencode($userName) ?>&userRol=<?= urlencode($userRol) ?>&rolNombre=<?= urlencode($rolNombre) ?>#compras" 
