<form action="" id="form" enctype="multipart/form-data">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-secondary text-white d-flex align-items-center gap-3">
            <i class="mdi mdi-barcode"></i> Ocultar stock Vehiculo
            <div class="form-check form-switch ms-2 mb-0">
                <input class="form-check-input" type="checkbox" id="maneja_vehiculo" name="maneja_vehiculo" data-switch="bool">
                <label class="form-check-label text-white" for="maneja_vehiculo" data-on-label="Si" data-off-label="No"></label>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-info text-white d-flex align-items-center gap-3">
            <i class="mdi mdi-cable-data"></i> Producto DROP (cable por metraje)
            <div class="form-check form-switch ms-2 mb-0">
                <input class="form-check-input" type="checkbox" id="es_drop" name="es_drop" data-switch="bool">
                <label class="form-check-label text-white" for="es_drop" data-on-label="Si" data-off-label="No"></label>
            </div>
        </div>
        <div class="card-body py-2">
            <p class="small text-muted mb-0">
                Marca este producto como DROP: en la liquidación se pedirá el metraje por
                inicio y fin del cable en lugar de una cantidad manual.
            </p>
        </div>
    </div>
    <div class="row">
        <div class="mb-3">
            <label for="categoria_liquidar" class="form-label">Categoria Liquidar *</label>
            <select class="form-select" id="categoria_liquidar" name="categoria_liquidar" data-required="true" data-label="Categoria Liquidar">
    ...
    <div class="row">
        ...
        <div class="col-md-3" id="col_stock">
            <div class="mb-3">
                <label for="stock" class="form-label">
                    Stock actual <small class="text-muted" id="lbl_stock_help">(manual)</small> *
                </label>
                <input type="number" id="stock" name="stock" class="form-control" placeholder="0" data-label="Stock">
            </div>
        </div>
        <div class="col-md-3" id="col_stock_serie" style="display:none">
            <div class="mb-3">
                <label class="form-label">Stock por series</label>
                <div class="form-control bg-light text-center">
                    <span class="fw-bold" id="stock_serie_cant">0</span>
                    <small class="text-muted"> series disponibles</small>
                </div>
                <div class="form-text text-success">
                    El stock se calcula automáticamente por cada serie registrada.
                </div>
            </div>
        </div>
        <span id="stock_serie_existentes" style="display:none">0</span>
        <div class="col-md-3">
            <div class="mb-3">
    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body" id="contenedor_series">
            ...
            <button type="button" class="btn btn-info btn-sm mt-1" id="btn_escanear_serie">
                <i class="mdi mdi-camera"></i> Escanear (cámara)
            </button>
            <p class="text-muted small mt-2 mb-0">
                También puedes usar una pistola lectora: ubícate en el campo de serie, escanea y presiona Enter.
            </p>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Escanear serie</h5>
