$(document).ready(function () {
    ...
    // Configuración
    const tabla = "#tabla-combustibles";

    const url_listar = "movilidad/combustibles/listar";
    const url_agregar = "movilidad/combustibles/agregar";
    const url_editar = "movilidad/combustibles/editar";
    const url_eliminar = "movilidad/combustibles/eliminar";
    ...
    const titulo_modal = "Nuevo Combustible";
    const titulo_modal_actualizar = "Actualizar Combustible";

    // Inicializar tabla básica
    const columnas = [
        { data: "nombre" },
        { data: "estado", render: renderEstado },
        { data: "id_combustible", render: renderAcciones }
    ];
