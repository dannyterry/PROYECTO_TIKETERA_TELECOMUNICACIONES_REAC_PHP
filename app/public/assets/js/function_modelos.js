$(document).ready(function () {
    ...
    // Configuración
    const tabla = "#tabla-modelos";

    const url_listar = "movilidad/modelos/listar";
    const url_agregar = "movilidad/modelos/agregar";
    const url_editar = "movilidad/modelos/editar";
    const url_eliminar = "movilidad/modelos/eliminar";
    ...
    const titulo_modal = "Nuevo Modelo";
    const titulo_modal_actualizar = "Actualizar Modelo";

    // Inicializar tabla básica
    const columnas = [
        { data: "nombre" },
        { data: "estado", render: renderEstado },
        { data: "id_modelo", render: renderAcciones }
    ];
