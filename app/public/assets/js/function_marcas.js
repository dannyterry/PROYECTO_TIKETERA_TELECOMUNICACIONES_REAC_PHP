$(document).ready(function () {
    ...
    // Configuración
    const tabla = "#tabla-marcas";

    const url_listar = "movilidad/marcas/listar";
    const url_agregar = "movilidad/marcas/agregar";
    const url_editar = "movilidad/marcas/editar";
    const url_eliminar = "movilidad/marcas/eliminar";
    ...
    const titulo_modal = "Nueva Marca";
    const titulo_modal_actualizar = "Actualizar Marca";

    // Inicializar tabla básica
    const columnas = [
        { data: "nombre" },
        { data: "estado", render: renderEstado },
        { data: "id_marca", render: renderAcciones }
    ];
