$(document).ready(function () {
    ...
    // Configuración
    const tabla = "#tabla-almacenes";

    const url_listar = "inventario/almacenes/listar";
    const url_agregar = "inventario/almacenes/agregar";
    const url_editar = "inventario/almacenes/editar";
    const url_eliminar = "inventario/almacenes/eliminar";
    ...
    const titulo_modal = "Nueva Almacen";
    const titulo_modal_actualizar = "Actualizar Almacen";
    ...
    const columnas = [
        ...
        { data: "id_almacen", render: renderAcciones }
    ];
