...
$(document).ready(function () {
    ...
    btn_modal_2.on('click', function () {
        enviarFormulario(url_stockear, form_2,
            function (r) {
                modal_2.modal("hide"); form_2[0].reset(); alertCorrecto(r.mensaje); tablaAjax.ajax.reload(); setTimeout(() => {
    ...
    function rellenarStockActual(data) {

        const tbody = document.getElementById("detalle_actual");
        ...
        data.productos.forEach(item => {
            ...
            if (
                ...
                item.series_asignadas.forEach(serie => {
