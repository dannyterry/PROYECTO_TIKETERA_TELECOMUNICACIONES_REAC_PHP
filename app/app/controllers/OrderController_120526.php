...
class OrderController extends Controller
{
    ...
    {
        $trabajadores = $this->staffModel->worker_listar_();
    ...
    {
        $id = $_POST['id'];
        $motivo_tipo_trabajo = $_POST['motivo_tipo_trabajo'];

        $respuesta = $this->orderModel->actualizar_motivo_($id, $motivo_tipo_trabajo);
        echo json_encode($respuesta, JSON_UNESCAPED_UNICODE);
    }
    ...
    private function cargarGrillaWin($cookieFile, $numeroPagina = 1)
    {
        ...
        $json_grilla = [
            ...
            "fechaSoliDesde" => "",
            "fechaSoliHasta" => "",
            "fechaVisiDesde" => $fechaActual,
            "fechaVisiHasta" => $fechaActual,
            "idPage" => 74,
            "localidad" => "0",
